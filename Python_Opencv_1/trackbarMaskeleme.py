...
cv2.createTrackbar("alh-h","bar",0,180,fonx)
cv2.createTrackbar("alh-s","bar",0,255,fonx)
cv2.createTrackbar("alh-v","bar",0,255,fonx)

cv2.createTrackbar("ust-h","bar",0,180,fonx)
cv2.createTrackbar("ust-s","bar",0,255,fonx)
cv2.createTrackbar("ust-v","bar",0,255,fonx)
